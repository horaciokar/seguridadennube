...
async function deleteUser(userId) {
    try {
      ...
      // Si la eliminación fue exitosa, volver a cargar la lista de usuarios
  ...
  // Modificar la función loadUsers() para incluir el botón de eliminar
  // Reemplaza la parte que crea las filas de la tabla en la función loadUsers()
  
  // Dentro de la función loadUsers(), reemplaza la parte donde creas las filas:
  /*
  users.forEach(user => {
  ...
  */
  ...
  users.forEach(user => {
    ...
    row.innerHTML = `
        ...
        <td>${user.email}</td>
        <td>${fechaFormateada}</td>
        <td><button class="btn-delete" data-id="${user.id}">Eliminar</button></td>
    `;
